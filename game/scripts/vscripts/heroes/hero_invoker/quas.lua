--[[ ============================================================================================================
	Author: Rook
	Date: April 02, 2015
	Called whenever Quas is cast.  Removes the third-to-most-recent orb on Invoker (if applicable) to make room for
...
--[[ ============================================================================================================
	Author: Rook
	Date: April 02, 2015
	Called when Quas is cast or upgraded.  Replaces the modifiers on the caster's modifier bar to
...
================================================================================================================= ]]
function invoker_quas_datadriven_on_spell_start(keys)
	invoker_replace_orb(keys, "particles/units/heroes/hero_invoker/invoker_quas_orb.vpcf")
end