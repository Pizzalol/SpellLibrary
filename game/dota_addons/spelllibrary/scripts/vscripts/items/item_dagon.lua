...
function item_dagon_on_spell_start(keys)
	...
	local particle_effect_intensity = 400 + (100 * dagon_level)  --Control Point 2 in Dagon's particle effect takes a number between 400 and 800, depending on its level.
