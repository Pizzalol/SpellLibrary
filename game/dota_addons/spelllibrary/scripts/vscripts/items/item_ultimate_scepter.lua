...
================================================================================================================= ]]
function item_ultimate_scepter_datadriven_on_created(keys)
...
================================================================================================================= ]]
function item_ultimate_scepter_datadriven_on_destroy(keys)
	...
	for i=0, 5, 1 do  --Search for Aghanim's Scepters in the player's inventory.
		...
		if current_item ~= nil then
			...
			if item_name == "item_ultimate_scepterq_datadriven" then
